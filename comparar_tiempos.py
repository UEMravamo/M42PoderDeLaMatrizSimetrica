...
# cada tiempo
tiempo_rapida = timeit.timeit(medir_tiempo_exponenciacion_rapida, number=repeticiones)
tiempo_binaria = timeit.timeit(medir_tiempo_exponenciacion_binaria, number=repeticiones)
print(f"Tiempo de exponenciación rápida (sin NumPy): {tiempo_rapida:.6f} segundos")
print(f"Tiempo de exponenciación binaria (con NumPy): {tiempo_binaria:.6f} segundos")
